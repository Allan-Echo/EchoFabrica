...
class ComposerStaticInit7afd3502fa83db7e0b9f0c89d2225fde
{
    ...
    public static $classMap = array (
        ...
        'sistema\\controlador\\AdminControlador' => __DIR__ . '/../..' . '/sistema/controlador/AdminControlador.php',
        'sistema\\controlador\\DashboardControlador' => __DIR__ . '/../..' . '/sistema/controlador/DashboardControlador.php',
        'sistema\\controlador\\LoginControlador' => __DIR__ . '/../..' . '/sistema/controlador/LoginControlador.php',
        'sistema\\controlador\\MaquinaControlador' => __DIR__ . '/../..' . '/sistema/controlador/MaquinaControlador.php',
        'sistema\\controlador\\SiteControlador' => __DIR__ . '/../..' . '/sistema/controlador/SiteControlador.php',
        'sistema\\controlador\\UsuarioControlador' => __DIR__ . '/../..' . '/sistema/controlador/UsuarioControlador.php',
        'sistema\\modelo\\Layout' => __DIR__ . '/../..' . '/sistema/modelo/Layout.php',
        'sistema\\modelo\\LayoutMaquina' => __DIR__ . '/../..' . '/sistema/modelo/LayoutMaquina.php',
        'sistema\\modelo\\Maquina' => __DIR__ . '/../..' . '/sistema/modelo/Maquina.php',
        'sistema\\modelo\\Producao' => __DIR__ . '/../..' . '/sistema/modelo/Producao.php',
        'sistema\\modelo\\UsuarioModelo' => __DIR__ . '/../..' . '/sistema/modelo/UsuarioModelo.php',
        'sistema\\nucleo\\Controlador' => __DIR__ . '/../..' . '/sistema/nucleo/Controlador.php',
        'sistema\\nucleo\\Erro' => __DIR__ . '/../..' . '/sistema/nucleo/Erro.php',
        'sistema\\nucleo\\Helpers' => __DIR__ . '/../..' . '/sistema/nucleo/Helpers.php',
        'sistema\\nucleo\\Mensagem' => __DIR__ . '/../..' . '/sistema/nucleo/Mensagem.php',
        'sistema\\nucleo\\Modelo' => __DIR__ . '/../..' . '/sistema/nucleo/Modelo.php',
        'sistema\\nucleo\\Sessao' => __DIR__ . '/../..' . '/sistema/nucleo/Sessao.php',
        'sistema\\nucleo\\suporte\\EasyPDO' => __DIR__ . '/../..' . '/sistema/nucleo/suporte/EasyPDO.php',
        'sistema\\nucleo\\suporte\\Template' => __DIR__ . '/../..' . '/sistema/nucleo/suporte/Template.php',
    );
